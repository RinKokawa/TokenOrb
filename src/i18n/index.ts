...
const dicts: Record<Lang, Dict> = {
  en: {
    ...
    'panel.nextReset': 'Next quota reset',
    ...
    'status.unauthorized': 'Credentials Missing',
    ...
    'settings.status.unauthorized':
      'Add credentials below or set MINIMAX_TOKEN in the bundled .env',
  ...
  zh: {
    ...
    'settings.status.unauthorized': '请在下方填写凭据或在外层 .env 中设置 MINIMAX_TOKEN',
